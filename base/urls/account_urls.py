...
urlpatterns = [
    ...
    path('transactionsById/<str:pk>/', views.getAllTransactionsByAccount, name='transactionsByAccountId'),
    path('closingBalanceForDate/account/<str:pk>/date/<str:date>/', views.getTransactionBalanceByDate, name='closingBalanceforDate'),
